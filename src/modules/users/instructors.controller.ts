...
export class InstructorsController {
  ...
  @Roles(...ADMIN_ROLES)
  @ApiOperation({ summary: '강사 직접 생성. 매니저 이상+재인증, users+profile+audit 원자 처리. 기본 시급은 재무 권한 필요.' })
  ...
  @Roles(...ADMIN_ROLES)
  @ApiOperation({ summary: '강사 프로필·Kinder 수정. 매니저 이상+재인증, audit 기록. 기본 시급은 재무 권한 필요.' })
  ...
  @Roles(...ADMIN_ROLES)
  @ApiOperation({ summary: '강사 soft delete. 매니저 이상+재인증, 활성 수업·스케줄·계약은 409.' })
