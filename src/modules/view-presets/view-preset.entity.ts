...
// [TBO-58 P2] createdBy = 소유자(IDOR 가드) — 계약 미승격(응답에 실리지만 FE 필수 아님).
//  NULL=레거시 공용(소유 기록 이전) — 매니저 이상만 수정/삭제.
export type ViewPreset = CalendarViewPreset & BaseRow & { createdBy?: number | null };
