...
const APP_FK: Array<{ child: string; field: string; parent: string }> = [
  ...
  { child: 'enrollments', field: 'counselCardId', parent: 'counsel_forms' },
  { child: 'enrollments', field: 'instructorId', parent: 'users' },
  { child: 'enrollments', field: 'deletedBy', parent: 'users' },
  ...
  { child: 'instructor_payouts', field: 'deletedBy', parent: 'users' },
  { child: 'class_sessions', field: 'enrollmentId', parent: 'enrollments' },
  { child: 'class_sessions', field: 'payoutId', parent: 'instructor_payouts' },
  { child: 'class_sessions', field: 'paidPayoutId', parent: 'instructor_payouts' },
  { child: 'schedule_requests', field: 'requesterId', parent: 'users' },
  { child: 'schedule_requests', field: 'targetSessionId', parent: 'class_sessions' },
  { child: 'schedule_requests', field: 'courseId', parent: 'courses' },
  { child: 'schedule_requests', field: 'instructorId', parent: 'users' },
  { child: 'schedule_requests', field: 'roomId', parent: 'rooms' },
  { child: 'schedule_requests', field: 'targetAvailabilityId', parent: 'availability_blocks' },
  { child: 'schedule_requests', field: 'decidedBy', parent: 'users' },
  { child: 'schedule_requests', field: 'createdSessionId', parent: 'class_sessions' },
  { child: 'schedule_requests', field: 'deletedBy', parent: 'users' },
